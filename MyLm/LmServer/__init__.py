...
BASE_CONFIG = [
    ...
    {"name": "Qwen3-VL-8B-Instruct",        "port": 8003, "env": "try", "par":"32B-Instruct"}, #["4B-Instruct","8B-Instruct","32B-Instruct"]
    {"name": "Qwen2.5-VL-7B-Instruct",      "port": 8004, "env": "try", "par":"7B-Instruct"}, #["3B-Instruct","7B-Instruct","32B-Instruct","72B-Instruct"]
    ...
    {"name": "Qwen3_Embedding_0.6B",        "port": 9001, "env": "try", "par":"0.6B"}, #["4B", "8B"]
]
